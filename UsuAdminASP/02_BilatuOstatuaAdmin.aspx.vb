    ...
    Protected Function ateraGonbidatua()
        ...
        Try
            ...
            If das1.HasRows() Then
                Dim bez
                While das1.Read()
                    bez = New Bezeroa(AES_Decrypt(das1.GetString(0), "encriptado"), AES_Decrypt(das1.GetString(1), "encriptado"), AES_Decrypt(das1.GetString(2), "encriptado"), AES_Decrypt(das1.GetInt32(3), "encriptado"), das1.GetString(4), AES_Decrypt(das1.GetString(5), "encriptado"))
                End While
                Return bez
            Else
                'Errore mezua
